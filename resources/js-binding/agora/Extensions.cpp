...
se::Value
agora::common::toSeValue(int intValue)
{
	return se::Value(intValue);
}
se::Value
agora::common::toSeValue(unsigned int uIntValue)
{
	return se::Value(uIntValue);
}
se::Value
agora::common::toSeValue(const char* strValue)
{
	return se::Value(strValue);
}

se::Value
agora::common::toSeValue(const RtcStats& rtcStats)
{
...
se::Value
agora::common::toSeValue(const AudioVolumeInfo& audioVolumeInfo)
{
	se::HandleObject obj(se::Object::createPlainObject());
...
se::Value
agora::common::toSeValue(const AudioVolumeInfo* audioVolumeInfo, int length)
{
...
agora::common::toSeValue(const LastmileProbeResult& lastmileProbeResult)
{
	...
	obj->setProperty("downlinkReport", toSeValue(lastmileProbeResult.downlinkReport));
	obj->setProperty("rtt", se::Value(lastmileProbeResult.rtt));
	return se::Value(obj);
}

se::Value
agora::common::toSeValue(
	const LastmileProbeOneWayResult& lastmileProbeOneWayResult)
{
	se::HandleObject obj(se::Object::createPlainObject());
	obj->setProperty("packetLossRate", se::Value(lastmileProbeOneWayResult.packetLossRate));
	obj->setProperty("jitter", se::Value(lastmileProbeOneWayResult.jitter));
	obj->setProperty("availableBandwidth", se::Value(lastmileProbeOneWayResult.availableBandwidth));
	return se::Value(obj);
}

se::Value
agora::common::toSeValue(const LocalVideoStats& localVideoStats)
{
	se::HandleObject obj(se::Object::createPlainObject());
	...
	obj->setProperty("encoderOutputFrameRate", se::Value(localVideoStats.encoderOutputFrameRate));
	obj->setProperty("rendererOutputFrameRate", se::Value(localVideoStats.rendererOutputFrameRate));
	obj->setProperty("targetBitrate", se::Value(localVideoStats.targetBitrate));
	obj->setProperty("targetFrameRate", se::Value(localVideoStats.targetFrameRate));
	obj->setProperty("qualityAdaptIndication", se::Value(localVideoStats.qualityAdaptIndication));
	obj->setProperty("encodedBitrate", se::Value(localVideoStats.encodedBitrate));
	obj->setProperty("encodedFrameWidth", se::Value(localVideoStats.encodedFrameWidth));
	obj->setProperty("encodedFrameHeight", se::Value(localVideoStats.encodedFrameHeight));
	obj->setProperty("encodedFrameCount", se::Value(localVideoStats.encodedFrameCount));
	obj->setProperty("codecType", se::Value(localVideoStats.codecType));
	return se::Value(obj);
}

se::Value
agora::common::toSeValue(const RemoteVideoStats& remoteVideoStats)
{
	se::HandleObject obj(se::Object::createPlainObject());
	...
	obj->setProperty("receivedBitrate", se::Value(remoteVideoStats.receivedBitrate));
	obj->setProperty("decoderOutputFrameRate", se::Value(remoteVideoStats.decoderOutputFrameRate));
	obj->setProperty("rendererOutputFrameRate",
		se::Value(remoteVideoStats.rendererOutputFrameRate));
	obj->setProperty("packetLossRate", se::Value(remoteVideoStats.packetLossRate));
	obj->setProperty("rxStreamType", se::Value(remoteVideoStats.rxStreamType));
	obj->setProperty("totalFrozenTime", se::Value(remoteVideoStats.totalFrozenTime));
	obj->setProperty("frozenRate", se::Value(remoteVideoStats.frozenRate));
	obj->setProperty("totalActiveTime", se::Value(remoteVideoStats.totalActiveTime));
	return se::Value(obj);
}

se::Value
agora::common::toSeValue(const LocalAudioStats& localAudioStats)
{
	se::HandleObject obj(se::Object::createPlainObject());
...
se::Value
agora::common::toSeValue(const RemoteAudioStats& remoteAudioStats)
{
	se::HandleObject obj(se::Object::createPlainObject());
	obj->setProperty("uid", se::Value(remoteAudioStats.uid));
	obj->setProperty("quality", se::Value(remoteAudioStats.quality));
	obj->setProperty("networkTransportDelay", se::Value(remoteAudioStats.networkTransportDelay));
	obj->setProperty("jitterBufferDelay", se::Value(remoteAudioStats.jitterBufferDelay));
	...
	obj->setProperty("receivedSampleRate", se::Value(remoteAudioStats.receivedSampleRate));
	obj->setProperty("receivedBitrate", se::Value(remoteAudioStats.receivedBitrate));
	obj->setProperty("totalFrozenTime", se::Value(remoteAudioStats.totalFrozenTime));
	obj->setProperty("frozenRate", se::Value(remoteAudioStats.frozenRate));
	obj->setProperty("totalActiveTime", se::Value(remoteAudioStats.totalActiveTime));
	return se::Value(obj);
}

se::Value
agora::common::toSeValue(const UserInfo& userInfo)
{
	se::HandleObject obj(se::Object::createPlainObject());
...
se::Value
agora::common::toSeValue(const Rectangle& rectangle)
{
	se::HandleObject obj(se::Object::createPlainObject());
...
se::Value
agora::common::toSeValue(const Rectangle* rectangle, int length)
{
	se::HandleObject obj(se::Object::createArrayObject(length));
	for (int i = 0; i < length; ++i)
	{
