...
namespace agora
{
	namespace common
	{
		...
		public:
			...
			void
			functionCall(std::string callbackName)
			{
			...
			template<typename T>
			void
			functionCall(std::string callbackName, T t)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, T t, T1 t1)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, T t, T1 t1, T2 t2)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, T t, T1 t1, T2 t2, T3 t3)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, T t, T1 t1, T2 t2, T3 t3, T4 t4)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, T t, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, T t, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, const rtc::RtcStats rtcstats)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, const rtc::LocalVideoStats stats)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, const rtc::RemoteVideoStats stats)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, const rtc::RemoteAudioStats stats)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, uid_t uid, const rtc::UserInfo info)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, const rtc::LocalAudioStats stats)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
