...
namespace agora
{
	namespace common
	{
		...
		public:
			...
			void
			functionCall(std::string callbackName, std::string channelId)
			{
			...
			template<typename T>
			void
			functionCall(std::string callbackName, std::string channelId, T t)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, std::string channelId, T t, T1 t1)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, std::string channelId, T t, T1 t1, T2 t2)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
			...
			void
			functionCall(std::string callbackName, std::string channelId, T t, T1 t1, T2 t2, T3 t3)
			{
				cocos2d::Application::getInstance()->getScheduler()
					->performFunctionInCocosThread([=]()
					{
