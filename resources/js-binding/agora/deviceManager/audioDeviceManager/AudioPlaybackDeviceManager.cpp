...
namespace agora
{
    namespace common
    {
        ...
        AudioPlaybackDeviceManager::AudioPlaybackDeviceManager(rtc::IRtcEngine *mRtcEngine, ERROR_CODE& ret)
        {
        ...
        int
        AudioPlaybackDeviceManager::callApi(API_TYPE_DEVICE_MANAGER apiType, const std::string& parameters)
        {
        ...
        int
        AudioPlaybackDeviceManager::callApi(API_TYPE_DEVICE_MANAGER apiType, const std::string& parameters, void*& ptr)
        {
            int ret = ERROR_CODE::ERROR_OK;
            Document document;
            document.Parse(parameters.c_str());
        ...
        int
        AudioPlaybackDeviceManager::callApi(API_TYPE_DEVICE_MANAGER apiType, const std::string& parameters, void*& ptr, void*&ptr2)
        {
            int ret = ERROR_CODE::ERROR_OK;
            Document document;
            document.Parse(parameters.c_str());
            ...
            switch (apiType)
            {
                case API_TYPE_DEVICE_MANAGER::GET_DEVICE:
                {
                    ...
                    ret = getDevice(index, reinterpret_cast<char *>(ptr), reinterpret_cast<char *>(ptr2));
                }
                    break;

                case API_TYPE_DEVICE_MANAGER::GET_CURRENT_DEVICE_INFO:
                {
                    ret = getCurrentDeviceInfo(reinterpret_cast<char *>(ptr), reinterpret_cast<char *>(ptr2));
                }
                    break;
        ...
        int
        AudioPlaybackDeviceManager::getCount()
        {
            if (audioDeviceCollection)
            {
        ...
        int
        AudioPlaybackDeviceManager::getDevice(int index, char deviceName[MAX_DEVICE_ID_LENGTH], char deviceId[MAX_DEVICE_ID_LENGTH])
        {
            if (audioDeviceCollection)
            {
        ...
        int
        AudioPlaybackDeviceManager::getCurrentDevice(char deviceId[MAX_DEVICE_ID_LENGTH])
        {
        ...
        int
        AudioPlaybackDeviceManager::getCurrentDeviceInfo(char deviceId[MAX_DEVICE_ID_LENGTH], char deviceName[MAX_DEVICE_ID_LENGTH])
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::setDevice(const char deviceId[MAX_DEVICE_ID_LENGTH])
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::setDeviceVolume(int volume)
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::getDeviceVolume(int *volume)
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::setDeviceMute(bool mute)
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::getDeviceMute(bool *mute)
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::startDeviceTest(const char *testAudioFilePath)
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::stopDeviceTest()
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int
        AudioPlaybackDeviceManager::startAudioDeviceLoopbackTest(int indicationInterval)
        {
           if (audioDeviceManager && audioDeviceManager->get())
           {
        ...
        int
        AudioPlaybackDeviceManager::stopAudioDeviceLoopbackTest()
        {
           if (audioDeviceManager && audioDeviceManager->get())
           {
        ...
        void
        AudioPlaybackDeviceManager::release()
        {
            delete this;
        }
    }
