...
namespace agora
{
    namespace common
    {
        ...
        AudioRecordingDeviceManager::AudioRecordingDeviceManager(agora::rtc::IRtcEngine *mRtcEngine,
                                                                 ERROR_CODE &ret)
                                                                 {
        ...
        int
        AudioRecordingDeviceManager::callApi(API_TYPE_DEVICE_MANAGER apiType, const std::string& parameters)
        {
        ...
        int
        AudioRecordingDeviceManager::callApi(API_TYPE_DEVICE_MANAGER apiType, const std::string& parameters, void*& ptr)
        {
            int ret = ERROR_CODE::ERROR_OK;
            Document document;
            document.Parse(parameters.c_str());
        ...
        int
        AudioRecordingDeviceManager::callApi(API_TYPE_DEVICE_MANAGER apiType, const std::string& parameters, void*& ptr, void*&ptr2)
        {
            int ret = ERROR_CODE::ERROR_OK;
            Document document;
            document.Parse(parameters.c_str());
        ...
        int
        AudioRecordingDeviceManager::getCount()
        {
            if (audioDeviceCollection)
            {
        ...
        int
        AudioRecordingDeviceManager::getDevice(int index,
        ...
        int
        AudioRecordingDeviceManager::getCurrentDevice(char deviceId[rtc::MAX_DEVICE_ID_LENGTH])
        {
        ...
        int
        AudioRecordingDeviceManager::getCurrentDeviceInfo(char deviceId[rtc::MAX_DEVICE_ID_LENGTH],
                                                          char deviceName[rtc::MAX_DEVICE_ID_LENGTH])
                                                          {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int AudioRecordingDeviceManager::setDevice(const char deviceId[rtc::MAX_DEVICE_ID_LENGTH])
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int AudioRecordingDeviceManager::startDeviceTest(const char *testAudioFilePath)
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        int AudioRecordingDeviceManager::startAudioDeviceLoopbackTest(int indicationInterval)
        {
            if (audioDeviceManager && audioDeviceManager->get())
            {
        ...
        void AudioRecordingDeviceManager::release()
        {
            delete this;
        }
    }
