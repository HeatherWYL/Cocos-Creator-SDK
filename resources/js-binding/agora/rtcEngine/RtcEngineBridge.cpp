...
namespace agora
{
	namespace common
	{
			...
			const std::string& parameters)
		{
			...
			case API_TYPE_AUDIO_EFFECT::SET_LOCAL_VOICE_PITCH:
			{
				double pitch = -1.0;
				get_parameter_double(document, "pitch", pitch, ret);
				CHECK_RET_ERROR(ret)
			...
			case API_TYPE_AUDIO_EFFECT::SET_LOCAL_VOICE_EQUALIZATION:
			{
				int bandFrequency;
			...
			case API_TYPE_AUDIO_EFFECT::SET_LOCAL_VOICE_REVERB:
			{
				int reverbKey;
			...
			case API_TYPE_AUDIO_EFFECT::SET_LOCAL_VOICE_CHANGER:
			{
				int voiceChanger;
			...
			case API_TYPE_AUDIO_EFFECT::SET_LOCAL_VOICE_REVERB_PRESET:
			{
				int reverbPreset;
			...
			case API_TYPE_AUDIO_EFFECT::SET_AUDIO_MIXING_PITCH:
			{
				int pitch;
			...
			case API_TYPE_AUDIO_EFFECT::SET_EXTERNAL_AUDIO_SOURCE:
			{
				bool enabled = false;
				get_parameter_bool(document, "enabled", enabled, ret);
				CHECK_RET_ERROR(ret)
			...
			case API_TYPE_AUDIO_EFFECT::SET_EXTERNAL_AUDIO_SINK:
			{
				bool enabled = false;
				get_parameter_bool(document, "enabled", enabled, ret);
				CHECK_RET_ERROR(ret)
			...
			case API_TYPE_AUDIO_EFFECT::SET_RECORDING_AUDIO_FRAME_PARAMETERS:
			{
				int sampleRate;
				get_parameter_int(document, "sampleRate", sampleRate, ret);
				CHECK_RET_ERROR(ret)
			...
			case API_TYPE_AUDIO_EFFECT::SET_PLAYBACK_AUDIO_FRAME_PARAMETERS:
			{
				int sampleRate;
				get_parameter_int(document, "sampleRate", sampleRate, ret);
				CHECK_RET_ERROR(ret)
			...
			case API_TYPE_AUDIO_EFFECT::SET_MIXED_AUDIO_FRAME_PARAMETERS:
			{
				int sampleRate;
				get_parameter_int(document, "sampleRate", sampleRate, ret);
				CHECK_RET_ERROR(ret)
		...
		int
		RtcEngineBridge::getUserInfoByUid(uid_t uid, UserInfo* userInfo)
		{
		...
		int
		RtcEngineBridge::setRemoteRenderMode(uid_t userId, RENDER_MODE_TYPE renderMode)
		{
		...
		int
		RtcEngineBridge::setRemoteRenderMode(uid_t userId,
			RENDER_MODE_TYPE renderMode,
			VIDEO_MIRROR_MODE_TYPE mirrorMode)
		{
		...
		int
		RtcEngineBridge::setRemoteUserPriority(uid_t uid, PRIORITY_TYPE userPriority)
		{
		...
		int
		RtcEngineBridge::muteRemoteAudioStream(uid_t userId, bool mute)
		{
		...
		int
		RtcEngineBridge::muteRemoteVideoStream(uid_t userId, bool mute)
		{
		...
		int
		RtcEngineBridge::setRemoteVideoStreamType(uid_t userId, REMOTE_VIDEO_STREAM_TYPE streamType)
		{
		...
		int
		RtcEngineBridge::setRemoteVoicePosition(uid_t uid, double pan, double gain)
		{
