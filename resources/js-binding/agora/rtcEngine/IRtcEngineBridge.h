...
namespace agora
{
	namespace common
	{
		...
		public:
			...
			virtual int
			initEventHandler(rtc::IRtcEngineEventHandler* eventHandler) = 0;
			...
			virtual int
			callApi_audioEffect(API_TYPE_AUDIO_EFFECT apiType, const std::string& parameters) = 0;

			virtual void
			release(bool sync = false) = 0;

			virtual IRtcChannelBridge*
			createChannel(const char* channelId) = 0;
