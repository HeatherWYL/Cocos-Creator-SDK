...
declare class AgoraRtcEvents {
     ...
     */
    onLeaveChannel: (stats: agora.RtcStats) => void;
     ...
     */
    onClientRoleChanged: (oldRole: agora.CLIENT_ROLE_TYPE, newRole: agora.CLIENT_ROLE_TYPE) => void;
     ...
     */
    onUserOffline: (uid: number, reason: agora.USER_OFFLINE_REASON_TYPE) => void;
     ...
     */
    onLastmileProbeResult: (result: agora.LastmileProbeResult) => void;
     ...
     */
    onRtcStats: (stats: agora.RtcStats) => void;
     ...
     */
    onLocalVideoStats: (stats: agora.LocalVideoStats) => void;
     ...
     * RemoteVideoStats.
     */
    onRemoteVideoStats: (stats: agora.RemoteVideoStats) => void;
     ...
     * See LocalAudioStats.
     */
    onLocalAudioStats: (stats: agora.LocalAudioStats) => void;
     ...
     */
    onRemoteAudioStats: (stats: agora.RemoteAudioStats) => void;
     ...
     */
    onLocalAudioStateChanged: (state: agora.LOCAL_AUDIO_STREAM_STATE, error: agora.LOCAL_AUDIO_STREAM_ERROR) => void;
     ...
     */
    onRemoteAudioStateChanged: (uid: number, state: agora.REMOTE_AUDIO_STATE, reason: agora.REMOTE_AUDIO_STATE_REASON, elapsed: number) => void;
     ...
     */
    onAudioPublishStateChanged: (channel: string, oldState: agora.STREAM_PUBLISH_STATE, newState: agora.STREAM_PUBLISH_STATE, elapseSinceLastState: number) => void;
     ...
     * @param elapseSinceLastState The time elapsed (ms) from the previous state to the current state.
     */
    onVideoPublishStateChanged: (channel: string, oldState: agora.STREAM_PUBLISH_STATE, newState: agora.STREAM_PUBLISH_STATE, elapseSinceLastState: number) => void;
     ...
     * @param elapseSinceLastState The time elapsed (ms) from the previous state to the current state.
     */
    onAudioSubscribeStateChanged: (channel: string, uid: number, oldState: agora.STREAM_SUBSCRIBE_STATE, newState: agora.STREAM_SUBSCRIBE_STATE, elapseSinceLastState: number) => void;
    /** Occurs when the audio subscribing state changes.
     *
     * @since v3.1.0
     *
     ...
     * @param elapseSinceLastState The time elapsed (ms) from the previous state to the current state.
     */
    onVideoSubscribeStateChanged: (channel: string, uid: number, oldState: agora.STREAM_SUBSCRIBE_STATE, newState: agora.STREAM_SUBSCRIBE_STATE, elapseSinceLastState: number) => void;
     ...
     */
    onAudioVolumeIndication: (speakers: agora.AudioVolumeInfo[], speakerNumber: number, totalVolume: number) => void;
     ...
     */
    onAudioDeviceStateChanged: (deviceId: string, deviceType: agora.MEDIA_DEVICE_TYPE, deviceState: agora.MEDIA_DEVICE_STATE_TYPE) => void;
     ...
     */
    onAudioDeviceVolumeChanged: (deviceType: agora.MEDIA_DEVICE_TYPE, volume: number, muted: boolean) => void;
     ...
     */
    onFacePositionChanged: (imageWidth: number, imageHeight: number, vecRectangle: agora.Rectangle[], vecDistance: number[], numFaces: number) => void;
     ...
     */
    onAudioMixingStateChanged: (state: agora.AUDIO_MIXING_STATE_TYPE, errorCode: agora.AUDIO_MIXING_ERROR_TYPE) => void;
    ...
    /** Occurs when the video device state changes.
     ...
     @param deviceState Device state: #MEDIA_DEVICE_STATE_TYPE.
     */
    onVideoDeviceStateChanged: (deviceId: string, deviceType: agora.MEDIA_DEVICE_TYPE, deviceState: agora.MEDIA_DEVICE_STATE_TYPE) => void;
     ...
     */
    onLocalVideoStateChanged: (localVideoState: agora.LOCAL_VIDEO_STREAM_STATE, error: agora.LOCAL_VIDEO_STREAM_ERROR) => void;
     ...
     */
    onRemoteVideoStateChanged: (uid: number, state: agora.REMOTE_VIDEO_STATE, reason: agora.REMOTE_VIDEO_STATE_REASON, elapsed: number) => void;
     ...
     */
    onChannelMediaRelayStateChanged: (state: agora.CHANNEL_MEDIA_RELAY_STATE, code: agora.CHANNEL_MEDIA_RELAY_ERROR) => void;
    /** Reports events during the media stream relay.
     *
     * @param code The event code in #CHANNEL_MEDIA_RELAY_EVENT.
     */
    onChannelMediaRelayEvent: (code: agora.CHANNEL_MEDIA_RELAY_EVENT) => void;
     ...
     */
    onRtmpStreamingStateChanged: (url: string, state: agora.RTMP_STREAM_PUBLISH_STATE, errCode: agora.RTMP_STREAM_PUBLISH_ERROR) => void;
     ...
     */
    onRtmpStreamingEvent: (url: string, eventCode: agora.RTMP_STREAMING_EVENT) => void;
     ...
     */
    onStreamInjectedStatus: (url: string, uid: number, status: agora.INJECT_STREAM_STATUS) => void;
     ...
     */
    onAudioRouteChanged: (routing: agora.AUDIO_ROUTE_TYPE) => void;
     ...
     */
    onConnectionStateChanged: (state: agora.CONNECTION_STATE_TYPE, reason: agora.CONNECTION_CHANGED_REASON_TYPE) => void;
     ...
     */
    onNetworkTypeChanged: (type: agora.NETWORK_TYPE) => void;
     ...
     */
    onUserInfoUpdated: (uid: number, info: agora.UserInfo) => void;
    /** Occurs when the local user receives the metadata.

     @param metadata The received Metadata.
     */
    onMetadataReceived: (metadata: agora.Metadata) => void;
}
/**
 * @ignore
 */
