declare namespace agora {
    ...
    function initWithAreaCode(appId: string, areaCode: number): void;
    ...
    /** **DEPRECATED** Sets the built-in encryption mode.
     ...
     - < 0: Failure.
     */
    function setEncryptionMode(encryptionMode: string): number;
